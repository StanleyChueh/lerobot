...
if __name__ == "__main__":
    ...
    green_neurons = rank_color_neurons(
        metadata=bundle["metadata"],
        target_color="green",
        other_colors=["red", "blue", "black", "yellow", "white"],
        top_n=10,
        max_color_rank=3,
        min_color_hits=1,
        min_clean_ratio=0.40,
    ...
    yellow_neurons = rank_color_neurons(
        metadata=bundle["metadata"],
        target_color="yellow",
        other_colors=["red", "blue", "black", "pink", "white"],
        top_n=10,
        max_color_rank=3,
        min_color_hits=1,
        min_clean_ratio=0.40,
    ...
    cube_neurons = rank_color_neurons(
        metadata=bundle["metadata"],
        target_color="cube",
        other_colors=["red", "black", "blue", "green", "yellow", "white", "block"],
        top_n=10,
        max_color_rank=3,
        min_color_hits=1,
        min_clean_ratio=0.40,
    ...
    block_neurons = rank_color_neurons(
        metadata=bundle["metadata"],
        target_color="block",
        other_colors=["red", "black", "blue", "green", "yellow", "white", "cube"],
        top_n=10,
        max_color_rank=3,
        min_color_hits=1,
        min_clean_ratio=0.40,
    ...
    color_ranking_results = {
        ...
        "Cube Shape": cube_neurons,
        "Block Shape": block_neurons,
        "Green Object": green_neurons,
        "Yellow Object": yellow_neurons
    }
