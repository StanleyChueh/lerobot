...
class MetaWriter:
    ...
    def write_info(self) -> None:
        ...
        # === 自動偵測影片影像 shape ===
        sample_video_path = self.root / "videos/chunk-000/observation.images.image_front_eye/episode_000000.mp4"
        ...
        info = {
            ...
            "total_tasks": 1,
            "total_videos": total_eps * 3,  # 3 views
            ...
            "features": {
                ...
                "observation.state": {
                    "dtype": "float32",
                    "shape": [8],
                    "names": {"motors": ["joint0_state", "joint1_state", "joint2_state", "joint3_state", "joint4_state", "joint5_state", "joint6_state", "width"]},
                },
                "action": {
                    "dtype": "float32",
                    "shape": [8],
