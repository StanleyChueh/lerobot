...
class StatsGenerator:
    ...
    def generate(self) -> None:
        ...
        if "observation.state" in all_df.columns:
            ...
            state_cols = [
                "j0", "j1", "j2", "j3", "j4", "j5", "j6", "gripper_width"
            ]
        ...
        for folder, stat_key in [
            ("observation.images.image_front_eye", "observation.images.image_front_eye"),
            ("observation.images.image_rear_eye", "observation.images.image_rear_eye"),
            ("observation.images.image_front_view", "observation.images.image_front_view"),
        ]:
